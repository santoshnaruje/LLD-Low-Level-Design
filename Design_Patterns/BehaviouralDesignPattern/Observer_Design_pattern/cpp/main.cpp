...
int main() {
    std::cout << "=== Observer Design Pattern Demo ===\n" << std::endl;
    
    // Create the Observable (Subject)
    WeatherStation weatherStation;
    
    // Create Observers
    MobileDisplay mobileDisplay(&weatherStation);
    TVDisplay tvDisplay(&weatherStation);
    ...
    std::cout << "\n--- Removing Mobile Display Observer ---" << std::endl;
    ...
    std::cout << "\n--- Adding Mobile Display Observer Back ---" << std::endl;
    weatherStation.add(&mobileDisplay);
